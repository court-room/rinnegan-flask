...
def test_get_users(test_app, monkeypatch):
    ...
    monkeypatch.setattr(views, "get_all_users", mocks.get_all_users)
...
def test_remove_user(test_app, monkeypatch):
    ...
    monkeypatch.setattr(views, "get_user_by_id", mocks.get_user_by_id)
    monkeypatch.setattr(views, "remove_user", mocks.remove_user)
...
def test_update_user(test_app, monkeypatch):
    ...
    monkeypatch.setattr(views, "get_user_by_id", mocks.get_user_by_id)
    monkeypatch.setattr(views, "update_user", mocks.update_user)
